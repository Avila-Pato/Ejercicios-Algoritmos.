...
function FabricaJuguetes(giftsToProduce: any[]) {
    return giftsToProduce.reduce((acc, item) => {
        // Validar que quantity sea un número válido > 0
...
const result1 = FabricaJuguetes(production1)
console.log(result1)
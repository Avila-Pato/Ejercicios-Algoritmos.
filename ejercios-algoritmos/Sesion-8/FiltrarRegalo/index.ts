...
// Ayuda a Santa escribiendo una función que reciba una lista de nombres 
// de regalos y devuelva una nueva lista que solo contenga los regalos sin defectos.
...
function FiltrarRegalos(gifts: string[]) {
    return gifts.filter((gift) => !gift.includes("#"))
}

const gifts1 = ['car', 'doll#arm', 'ball', '#train']
const good1 = FiltrarRegalos(gifts1)
console.log(good1)